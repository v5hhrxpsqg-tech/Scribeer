...
# --- 1. INITIALISATIE ---
st.set_page_config(page_title="Scribeer.nl", page_icon="🐻", layout="wide")
...
st.divider() # Een subtiel lijntje voor de overzichtelijkheid
...
if not ingelogd:
    ...
    with col_login:
        ...
        st.link_button("🔑 Log in met Google", auth_data.url)
else:
